 ...
 */
export default function StationMarker({station_data, time = new Date(),station_descriptions }) {
  const { selected_station, setSelectedStation, setSelectedTab, setIsStationDashOpen } = useContext(MapStates);
