      ...
      <main className={aboutStyles.mainContent}>
        <section className={aboutStyles.aboutSection}>
         ...
         <br></br>
          ...
          <h3 className={aboutStyles.subheading} id="section2.1">Hurricane Juan 2003</h3>
          <p className={aboutStyles.lightText}>
          ...
          <figure className={aboutStyles.imageContainer}>
            <Image
              src="/about_page/hurricane_juan_2003.png"
              ...
              height={315}
            />
            <figcaption className={aboutStyles.imageCaption}>
              <div>
          ...
          <h3 className={aboutStyles.subheading} id="section2.2">Hurricane Dorian 2019</h3>
          <p className={aboutStyles.lightText}>
          ...
          <figure className={aboutStyles.imageContainer}>
            <Image
              src="/about_page/hurricane_dorian_2019.png"
              alt="Storm surge from Hurricane Juan (2003)"
              className={aboutStyles.aboutPageImg}
              width={350}
              height={315}
          ...
          <h3 className={aboutStyles.subheading} id="section2.3">Hurricane Fiona 2022</h3>
          <p className={aboutStyles.lightText}>
          ...
          <figure className={aboutStyles.imageContainer}>
            <Image
              src="/about_page/hurricane_fiona_2022.png"
              alt="Storm surge from Hurricane Juan (2003)"
              className={aboutStyles.aboutPageImg}
              width={350}
              height={315}
