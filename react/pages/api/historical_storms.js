...
export default async function handler(req, res) {
    ...
    const storm_id = (req.query["id"]) ? req.query["id"] : "";
    ...
    try {
        const result = await wfs_query(storm_name, season, source, source_type, storm_id, filters, "", true)
