DROP TABLE IF EXISTS public."ibtracs_historical_storms";
CREATE TABLE IF NOT EXISTS public."ibtracs_historical_storms" (
	...
	"KMA_WIND" DECIMAL(5), 
	"KMA_PRES" DECIMAL(5), 
	"KMA_R50_DIR" DECIMAL(5), 
	"KMA_R50_LONG" DECIMAL(5), 
	"KMA_R50_SHORT" DECIMAL(5), 
	"KMA_R30_DIR" DECIMAL(5), 
	"KMA_R30_LONG" DECIMAL(5), 
	"KMA_R30_SHORT" DECIMAL(5), 
...
CREATE INDEX IF NOT EXISTS ibtracs_historical_storms_geom_idx
    ON public.ibtracs_historical_storms 
    USING GIST (geom);
